    ...
    public function attributeLabels()
    {
        return
            [
                ...
                'f11_comment_proc'=>'Комментарий прокуратуры к пункту 1.1',
                'f12_comment_proc'=>'Комментарий прокуратуры к пункту 1.2',
                'f131_comment_proc'=>'Комментарий прокуратуры к пункту 1.3.1',
                'f132_comment_proc'=>'Комментарий прокуратуры к пункту 1.3.2',
                'f21_comment_proc'=>'Комментарий прокуратуры к пункту 2.1',
                'f22_comment_proc'=>'Комментарий прокуратуры к пункту 2.2',
